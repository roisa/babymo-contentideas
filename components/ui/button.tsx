...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-full text-sm font-semibold ring-offset-background transition-all focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 active:scale-[0.98]",
  {
    variants: {
      variant: {
        default: "bg-babymo-green text-white hover:bg-babymo-green-dark shadow-ios-sticker",
        ...
        glass: "glass-card hover:bg-white/90 text-foreground rounded-full",
        accent: "bg-babymo-yellow text-babymo-ink hover:bg-babymo-yellow/90 shadow-ios-sticker",
        coral: "bg-babymo-coral text-white hover:bg-babymo-coral-dark shadow-ios-sticker",
